...
require("./app.css");
const dom = require("../test/helpers/dom");
...
form.onsubmit = function (e) {
    ...
    const videoPlayer = new VideoPlayer_1.VideoPlayer(dom.appendBodyElement("div", `video-player-${videoPlayers.length}`, "video-player"));
